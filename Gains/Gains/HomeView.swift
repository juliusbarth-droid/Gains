...
struct HomeView: View {
  ...
  private var cockpitSpotlightCard: some View {
    ...
    return VStack(alignment: .leading, spacing: 0) {
      ...
      .accessibilityHint("Öffnet deinen Fortschritt mit Verlauf, Wochenübersicht, Serie und Volumen")
  ...
  private var nutritionSpotlightCard: some View {
    ...
    .accessibilityHint(kcalGoal == 0 ? "Öffnet deine Ernährung direkt zur Einrichtung deines Kalorienziels" : "Öffnet deine heutige Ernährung und dein Kalorienziel")
  }
  ...
  private var compactNutritionCard: some View {
    ...
    .accessibilityHint(store.nutritionTargetCalories == 0 ? "Öffnet deine Ernährung direkt zur Einrichtung deines Kalorienziels" : "Öffnet deine heutige Ernährung mit Kalorien, Eiweiß und Mahlzeiten")
  }
  ...
  private var liveBPMBanner: some View {
    if ble.isConnected {
      ...
      .accessibilityValue({
        guard let liveHeartRate = ble.liveHeartRate, liveHeartRate > 0 else {
          return "Keine Live-Herzfrequenz"
        }
        return "\(liveHeartRate) BPM"
      }())
      .accessibilityHint("Öffnet dein Profil mit dem verbundenen Heart-Rate-Sensor und weiteren Gerätedaten")
    }
  }
      ...
      ZStack {
        ...
        if let workout = store.activeWorkout {
          ...
          VStack(spacing: GainsSpacing.s) {
            ...
            Text("Aktives Training wird vorbereitet ...")
