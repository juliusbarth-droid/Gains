...
extension GainsStore {
  ...
  // MARK: - Demo-Seed (Community-Hub)
  //
  // 2026-05-30: Der Community-Hub (Einstieg über Home) zeigt lokale Demo-
  // Inhalte, solange es kein Backend gibt. Anders als das DEBUG-`loadDemoData()`
  // (das Workout-/Lauf-/Nutrition-Historie überschreibt) füllt dieser Seeder
  // NUR die drei Community-Arrays — und auch nur, wenn sie leer sind. Damit
  // gehen vom User selbst erstellte Threads/Treffs/Posts nie verloren, und der
  // Hub wirkt beim ersten Öffnen trotzdem lebendig.
  func seedCommunityDemoDataIfNeeded() {
    var didSeed = false
