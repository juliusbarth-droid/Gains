  ...
  var body: some View {
    NavigationStack {
      ...
      .confirmationDialog(
        ...
        Text("Wenn du den Lauf behältst, kehrst du direkt zu ihm zurück und kannst ihn fortsetzen oder speichern. Wenn du ihn verwirfst, landen Distanz, Pace und Runden nicht im Feed oder in den Routen.")
      }
      .onAppear {
