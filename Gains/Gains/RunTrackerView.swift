...
private struct LiveRunView: View {
  ...
  private func indoorStepperButton(label: String, deltaKm: Double, accent: Bool = false) -> some View {
    ...
    .accessibilityValue(run.isPaused ? "Lauf pausiert" : "Aktiver Lauf, bereit für Distanzanpassung")
  ...
  private var liveControls: some View {
    HStack(spacing: GainsSpacing.tight) {
      ...
      .accessibilityValue(run.isPaused ? "Lauf pausiert" : "Aktiver Lauf, bereit für neue Runde")
    ...
    NavigationStack {
      ...
      .safeAreaInset(edge: .bottom) {
        VStack(spacing: GainsSpacing.tight) {
          ...
          .accessibilityValue(canSaveRun ? "Bereit zum Speichern, landet im Feed und in den Routen" : "Noch nicht speicherbar, Lauf braucht mindestens 30 Sekunden oder 0,01 Kilometer")
          .accessibilityHint(canSaveRun ? "Speichert deinen Lauf mit Titel, Notiz und Gefühl, danach landet er im Feed und in den Routen" : "Nicht verfügbar, bis dein Lauf mindestens 30 Sekunden oder 0,01 Kilometer erreicht hat")
          .disabled(!canSaveRun)
          ...
          .accessibilityHint("Öffnet die Bestätigung zum Verwerfen dieses noch nicht gespeicherten Laufs")
        }
        .padding(.horizontal, GainsSpacing.l)
      ...
      .confirmationDialog(
        ...
        Text("Wenn du den Lauf behältst, kannst du ihn weiter fortsetzen oder speichern. Wenn du ihn verwirfst, landen Distanz, Pace und Runden nicht im Feed oder in den Routen.")
      }
      .onAppear {
