  ...
  var body: some View {
    GeometryReader { proxy in
      ...
      ZStack(alignment: .topLeading) {
        ...
        // 2026-05-14 (Design-Loop 9): Drei-Layer-Halo (Far → Near → Core)
        // statt zwei-Layer + Outline. Wirkt wie ein leuchtender Live-Pin
        // — passt zum HUD-Vokabular der App, kostet keine extra Frames.
        if let last = points.last {
          ...
          ZStack {
            ...
            Circle()
              ...
              .overlay(Circle().stroke(GainsColor.card, lineWidth: 1.6))
