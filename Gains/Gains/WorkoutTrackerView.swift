...
struct WorkoutTrackerView: View {
  ...
  private func bottomCTA(_ workout: WorkoutSession) -> some View {
    ...
    .accessibilityHint(isEmpty ? "Öffnet die Übungsauswahl für dein Workout" : isComplete ? "Schließt das aktuelle Workout ab" : isSetActive ? (isActivePendingSet ? "Markiert diesen aktiven Satz als abgeschlossen" : "Stoppt den Timer für diesen aktiven Satz") : "Startet den nächsten offenen Satz")
  }
...
private struct CompactSetRow: View {
  ...
  var body: some View {
    ...
    return HStack(spacing: GainsSpacing.xsPlus) {
      ...
      .accessibilityValue(isCompleted ? "Satz bereits abgeschlossen" : (isTimerRunning ? "Aktiver Satz, Timer läuft" : "Satz offen, bereit zum Starten"))
