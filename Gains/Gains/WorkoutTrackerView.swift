  ...
  var body: some View {
    NavigationStack {
      ...
      .alert("Training abschließen?", isPresented: $isFinishing) {
        ...
        Text("Wenn du dein aktives Training speicherst, wird es gespeichert und dein aktueller Fortschritt bleibt erhalten. Wenn du es fortsetzt, kehrst du direkt zu deinem aktiven Training zurück. Wenn du dein aktives Training verwirfst, wird es verworfen und dein aktueller Fortschritt geht verloren.")
      }
    ...
    return HStack(alignment: .center, spacing: GainsSpacing.s) {
      ...
      VStack(alignment: .leading, spacing: GainsSpacing.xxs) {
        Text("Alle Sätze erledigt")
          .font(GainsFont.headline)
          .foregroundStyle(GainsColor.ink)
        Text("Stark – jetzt die Abschlussbestätigung öffnen und dein Training speichern, fortsetzen oder verwerfen.")
          .font(GainsFont.caption)
          .foregroundStyle(GainsColor.softInk)
