...
struct WorkoutTrackerView: View {
    ...
    NavigationStack {
      ...
      .toolbar {
        ToolbarItem(placement: .topBarLeading) {
          ...
          .accessibilityHint("Schließt den aktiven Trainingsbildschirm, dein aktives Training bleibt erhalten und du kehrst zur Trainingsübersicht zurück")
        }
        ...
        ToolbarItem(placement: .topBarTrailing) {
          ...
          .accessibilityValue(store.activeWorkout == nil ? "Kein aktives Training geöffnet" : "Dein aktives Training kann gespeichert, fortgesetzt oder verworfen werden")
  ...
  private var addExerciseButton: some View {
    ...
    .accessibilityHint("Öffnet die Übungsauswahl, um eine Übung zu deinem aktiven Training hinzuzufügen")
  }
