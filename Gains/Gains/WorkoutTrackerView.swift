...
struct WorkoutTrackerView: View {
  ...
  var body: some View {
    NavigationStack {
      ...
      .alert("Training abschließen?", isPresented: $isFinishing) {
        ...
        Text("Wenn du das Training speicherst, bleibt dein aktueller Fortschritt erhalten. Wenn du es verwirfst, geht er verloren.")
      }
  ...
  private func finishedCard(_ workout: WorkoutSession) -> some View {
    ...
    .accessibilityHint("Zeigt deine Abschlusszusammenfassung vor dem Trainingsende")
  }
