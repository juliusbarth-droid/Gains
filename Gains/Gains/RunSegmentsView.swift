...
struct SegmentCreatorSheet: View {
  ...
  private func createSegment() {
    ...
    // 2026-05-16 (Fertiger-Audit P0-4): Success-Haptik + Banner vor Dismiss.
    // Vorher schrieb createSegment still in den Store und dismisste — keine
    // Bestätigung dass die Persistierung geklappt hat.
    GainsErrorPresenter.shared.presentSuccess(.segmentSaved)
    dismiss()
  }
}
