...
struct ContentView: View {
  ...
  var body: some View {
    ...
    // (z. B. von Home auf Gym), räumen wir evtl. Overlay-/Sub-Tab-Reste
    // zentral weg. Programm-gesteuerte Tab-Wechsel machen das bereits in
    // AppNavigationStore; dieser onChange ist die Defensive-Linie für
    // direkte TabBar-Taps.
    .onChange(of: navigation.selectedTab) { _, newValue in
      navigation.handleManualTabChange(to: newValue)
    }
  }
