...
enum PersistenceKey {
  ...
  /// 2026-05-10 P1-3: Pause-Timer aus dem Kraft-Trainer (Date des Endpunkts +
  /// gewählte Pause-Dauer). Persistiert, damit ein Tab-Wechsel oder eine
  /// Memory-Eviction während der Pause die laufende Uhr nicht verliert.
  /// Nach dem Re-Open vergleicht die View den Endpunkt gegen Date() und
  /// entscheidet still vs. Haptik/Sound.
  static let activeRestTimerEndsAt = "gains_activeRestTimerEndsAt"
  static let activeRestDuration    = "gains_activeRestDuration"
