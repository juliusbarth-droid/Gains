...
struct WorkoutHubView: View {
  ...
  private var isInRunDayOneWindow: Bool {
    // 2026-05-10 G-P1-2 (Cardio-Variante): 24h-Cap entfernt — wer abends
    // onboardet und am nächsten Morgen die App öffnet, hatte sonst die Tour
    // verpasst, ohne jemals einen Lauf gemacht zu haben. Bedingung jetzt:
    // Onboarding ist abgeschlossen UND es liegt noch keine Cardio-Historie
    // vor. Analog zur Gym-Tab-Lösung in GymTodayTab.
