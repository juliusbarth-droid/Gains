...
struct BarcodeScannerSheet: View {
  ...
  let onLog: () -> Void
  // 2026-05-10 N-P1-24: Wenn der Parent eine Manuell-Suche-Übergabe setzt,
  // bekommt die Not-Found-Card einen zusätzlichen Sekundär-Button. Sonst bleibt
  // die alte Erneut/Abbrechen-Reihe erhalten.
  var onRequestManualSearch: (() -> Void)? = nil
